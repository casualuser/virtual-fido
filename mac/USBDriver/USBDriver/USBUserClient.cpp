...
const IOUserClientMethodDispatch
    USBDriverMethodChecks[NumberOfUSBDriverMethods] = {
        [USBDriverMethodType_SendFrame] =
            {
                .function = (IOUserClientMethodFunction)
                    USBUserClient::StaticHandleSendFrame,
        ...
        [USBDriverMethodType_NotifyFrame] =
            {
                .function = (IOUserClientMethodFunction)
                    USBUserClient::StaticHandleNotifyFrame,
        ...
        [USBDriverMethodType_GetFrame] =
            {
                .function = (IOUserClientMethodFunction)
                    USBUserClient::StaticHandleGetFrame,
                .checkScalarInputCount = 0,
                .checkScalarOutputCount = 0,
                .checkStructureInputSize = 0,
        ...
        [USBDriverMethodType_StartDevice] =
            {
                .function = (IOUserClientMethodFunction)
                    USBUserClient::StaticHandleStartDevice,
                .checkCompletionExists = false,
                .checkScalarInputCount = 0,
                .checkScalarOutputCount = 0,
            },
        [USBDriverMethodType_StopDevice] = {
            .function = (IOUserClientMethodFunction)
                USBUserClient::StaticHandleStopDevice,
            .checkCompletionExists = false,
            .checkScalarInputCount = 0,
            .checkScalarOutputCount = 0,
        }};
...
kern_return_t
USBUserClient::ExternalMethod(uint64_t selector,
...
kern_return_t
USBUserClient::StaticHandleStartDevice(USBUserClient *target, void *reference,
                                       IOUserClientMethodArguments *arguments) {
  return target->HandleStartDevice(reference, arguments);
}

kern_return_t
USBUserClient::HandleStartDevice(void *reference,
                                 IOUserClientMethodArguments *arguments) {
  Log("StartDevice()");
...
kern_return_t
USBUserClient::StaticHandleStopDevice(USBUserClient *target, void *reference,
                                      IOUserClientMethodArguments *arguments) {
  return target->HandleStopDevice(reference, arguments);
}

kern_return_t
USBUserClient::HandleStopDevice(void *reference,
                                IOUserClientMethodArguments *arguments) {
  clearDeviceIfNecessary();
  return kIOReturnSuccess;
}
...
kern_return_t
USBUserClient::StaticHandleSendFrame(USBUserClient *target, void *reference,
                                     IOUserClientMethodArguments *arguments) {
  return target->HandleSendFrame(reference, arguments);
}

kern_return_t
USBUserClient::HandleSendFrame(void *reference,
                               IOUserClientMethodArguments *arguments) {
  usb_driver_hid_frame_t *frame =
      (usb_driver_hid_frame_t *)arguments->structureInput->getBytesNoCopy();
  ...
  if (ivars->_device) {
    IOBufferMemoryDescriptor *report =
        createMemoryDescriptorWithBytes((void *)frame->data, frame->length);
...
kern_return_t
USBUserClient::StaticHandleNotifyFrame(USBUserClient *target, void *reference,
                                       IOUserClientMethodArguments *arguments) {
  return target->HandleNotifyFrame(reference, arguments);
}

kern_return_t
USBUserClient::HandleNotifyFrame(void *reference,
                                 IOUserClientMethodArguments *arguments) {
...
void USBUserClient::newHIDFrame(IOMemoryDescriptor *report,
...
kern_return_t
USBUserClient::StaticHandleGetFrame(USBUserClient *target, void *reference,
                                    IOUserClientMethodArguments *arguments) {
  return target->HandleGetFrame(reference, arguments);
}

kern_return_t
USBUserClient::HandleGetFrame(void *reference,
                              IOUserClientMethodArguments *arguments) {
  Log("GetFrame()");
  usb_driver_hid_frame_t *frame =
      (usb_driver_hid_frame_t *)linked_list_pop_front(ivars->saved_frames);
  if (frame == NULL) {
  ...
  arguments->structureOutput =
      OSData::withBytes(frame, sizeof(usb_driver_hid_frame_t));
